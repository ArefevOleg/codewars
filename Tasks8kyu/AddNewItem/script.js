...
function addExtra(list) {
  const newList = [...list]; // this creates a new copy of the list
  newList.push(13); // this adds a new item to the list
  return newList; // this returns the new list with the extra item
}